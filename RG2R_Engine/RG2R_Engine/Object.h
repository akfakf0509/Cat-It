...
public:
	...
	virtual void OnClickEnter() {} // 클릭할 때
	virtual void OnClickStay() {} // 클릭 중
	virtual void OnClickExit() {} // 클릭을 땠을 때
	...
	std::function<void()> onClickEnter = NULL;
	std::function<void()> onClickStay = NULL;
	std::function<void()> onClickExit = NULL;
